...
<div class="w3-content w3-container w3-padding-64" id="portfolio">
  ...
  <div class="w3-row-padding w3-center">
    <div class="w3-col m3">
    <img src="KL.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Owner name : หนึ่ง <br> Store Name: Bar Bq <br> Product:Bar BQ<br> Tel :0913326419 <br> Email : Pissanufc@gmail.com <br> Page :Bar BQ<br>ครบุรี <br> Page :Bar BQ<br>ครบุรี">
    <h4>Bar BQ</h4>
  </div>

  <div class="w3-col m3">
    <img src="p2.jpg" style="width:88%" onclick="onClick(this)" class="w3-hover-opacity" alt="ร้านชานม">
    <h4>ชานมโต๊โต</h4>
  </div>

  <div class="w3-col m3">
    <img src="p3.jpg" style="width:88%" onclick="onClick(this)" class="w3-hover-opacity" alt="ร้านขายลูกชิ้น">
    <h4>ลูกชิ้นสวรรค์</h4>
  </div>

  <div class="w3-col m3">
    <img src="p4.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="ร้านส้มตำ">
    <h4>ส้มตำนรก</h4>
  </div>
  </div>
