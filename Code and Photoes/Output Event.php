...
<div class="w3-content w3-container w3-padding-64" id="portfolio">
  ...
  <div class="w3-row-padding w3-center">
    ...
    <div class="w3-col m3">
      <img src="KN.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Market name:��Ҵ�ú���<br> Owner name : อ้น <br>Tel :091-3326412 <br> Email : Pissanufc@gmail.com <br> Page :ตลาดครบุรี <br> Address :ครบุรี">
      <h4>ตลาดครบุรี </h4>
    ...
    <div class="w3-col m3">
          ...
          <img src="1.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Event Name : งาน Event กันตนา<br>Tel :091-3326419 <br> Email : Pissanufc@gmail.com <br> <br> About Event : งาน Event ที่มีคุณภาพ <br> Location : ตลาดครบุรี <br>Category : งานเทศกาลดนตรี
<br> date :3/1/2018 <br> Time :19:00 - 23:00"> 
          <h4>งาน Event กันตนา</h4>
