...
CREATE TABLE IF NOT EXISTS `mydb`.`location` (
  ...
  PRIMARY KEY (`idlocation`, `market_idmarket`),
  INDEX `fk_location_market1_idx` (`market_idmarket` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`shop` (
  ...
  `location_market_idmarket1` INT NOT NULL,
  PRIMARY KEY (`idshop`),
  INDEX `fk_shop_shopStyle1_idx` (`shopStyle_idshopStyle` ASC),
  INDEX `fk_shop_location1_idx` (`location_idlocation` ASC, `location_market_idmarket1` ASC),
  ...
  CONSTRAINT `fk_shop_location1`
    FOREIGN KEY (`location_idlocation` , `location_market_idmarket1`)
    REFERENCES `mydb`.`location` (`idlocation` , `market_idmarket`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
